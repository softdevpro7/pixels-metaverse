...
//view
export const PixelsMetaverse_3_Amount = async (
	contract: TContract,
) => {
...
//view
export const PixelsMetaverse_3_BaseInfo = async (
	contract: TContract,
	arg?: {
...
//view
export const PixelsMetaverse_3_Collection = async (
	contract: TContract,
	arg?: {
...
//view
export const PixelsMetaverse_3_Composes = async (
	contract: TContract,
	arg?: {
...
//view
export const PixelsMetaverse_3_Material = async (
	contract: TContract,
	arg?: {
		uint256Params1: string | number; //uint256
	}
...
//view
export const PixelsMetaverse_3_User = async (
	contract: TContract,
	arg?: {
		addressParams1: string; //address
	}
...
//nonpayable
export const PixelsMetaverse_3_Register = async (
	contract: TContract,
) => {
	if ((contract as any)?.address && !(contract as any)?.methods) {
...
//nonpayable
export const PixelsMetaverse_3_SetConfig = async (
	contract: TContract,
	arg?: {
		role: string; //string
...
//view
export const PixelsMetaverse_3_GetMaterialLength = async (
	contract: TContract,
) => {
	if ((contract as any)?.address && !(contract as any)?.methods) {
...
//view
export const PixelsMetaverse_3_GetMaterial = async (
	contract: TContract,
	arg?: {
		id: string | number; //uint256
	}
...
//nonpayable
export const PixelsMetaverse_3_Make = async (
	contract: TContract,
	arg?: {
		name: string; //string
		category: string; //string
...
//nonpayable
export const PixelsMetaverse_3_ReMake = async (
	contract: TContract,
	arg?: {
		id: string | number; //uint256
		num: string | number; //uint256
...
//nonpayable
export const PixelsMetaverse_3_Collect = async (
	contract: TContract,
	arg?: {
		id: string | number; //uint256
	}
...
//nonpayable
export const PixelsMetaverse_3_CancelCollect = async (
	contract: TContract,
	arg?: {
		id: string | number; //uint256
...
//view
export const PixelsMetaverse_3_GetCollection = async (
	contract: TContract,
	arg?: {
		from: string; //address
	}
...
//view
export const PixelsMetaverse_3_GetCompose = async (
	contract: TContract,
	arg?: {
		id: string | number; //uint256
	}
...
//nonpayable
export const PixelsMetaverse_3_Compose = async (
	contract: TContract,
	arg?: {
...
//nonpayable
export const PixelsMetaverse_3_CancelCompose = async (
	contract: TContract,
	arg?: {
		ids: string | number; //uint256
	}
...
//nonpayable
export const PixelsMetaverse_3_Addition = async (
	contract: TContract,
	arg?: {
		ids: string | number; //uint256
...
//nonpayable
export const PixelsMetaverse_3_Subtract = async (
	contract: TContract,
	arg?: {
		ids: string | number; //uint256
		id: string | number; //uint256
...
//nonpayable
export const PixelsMetaverse_3_SetPMT721 = async (
	contract: TContract,
	arg?: {
...
//nonpayable
export const PixelsMetaverse_3_HandleTransfer = async (
	contract: TContract,
	arg?: {
		from: string; //address
		to: string; //address
