...
//nonpayable
export const PixelsMetaverse_Localhost31337_Addition = async (
	contract: TContract,
	arg?: {
...
//view
export const PixelsMetaverse_Localhost31337_Amount = async (
	contract: TContract,
) => {
	if ((contract as any)?.address && !(contract as any)?.methods) {
...
//view
export const PixelsMetaverse_Localhost31337_BaseInfo = async (
	contract: TContract,
	arg?: {
...
//nonpayable
export const PixelsMetaverse_Localhost31337_CancelCollect = async (
	contract: TContract,
	arg?: {
...
//nonpayable
export const PixelsMetaverse_Localhost31337_CancelCompose = async (
	contract: TContract,
	arg?: {
		ids: string | number; //uint256
	}
...
//nonpayable
export const PixelsMetaverse_Localhost31337_Collect = async (
	contract: TContract,
	arg?: {
		id: string | number; //uint256
	}
...
//view
export const PixelsMetaverse_Localhost31337_Collection = async (
	contract: TContract,
	arg?: {
...
//nonpayable
export const PixelsMetaverse_Localhost31337_Compose = async (
	contract: TContract,
	arg?: {
		ids: (string | number)[]; //uint256[]
		name: string; //string
...
//view
export const PixelsMetaverse_Localhost31337_Composes = async (
	contract: TContract,
	arg?: {
...
//view
export const PixelsMetaverse_Localhost31337_GetCollection = async (
	contract: TContract,
	arg?: {
		from: string; //address
	}
...
//view
export const PixelsMetaverse_Localhost31337_GetCompose = async (
	contract: TContract,
	arg?: {
		id: string | number; //uint256
	}
...
//view
export const PixelsMetaverse_Localhost31337_GetMaterial = async (
	contract: TContract,
	arg?: {
		id: string | number; //uint256
	}
...
//view
export const PixelsMetaverse_Localhost31337_GetMaterialLength = async (
	contract: TContract,
) => {
	if ((contract as any)?.address && !(contract as any)?.methods) {
...
//nonpayable
export const PixelsMetaverse_Localhost31337_HandleTransfer = async (
	contract: TContract,
	arg?: {
		from: string; //address
		to: string; //address
...
//nonpayable
export const PixelsMetaverse_Localhost31337_Make = async (
	contract: TContract,
	arg?: {
		name: string; //string
		category: string; //string
...
//view
export const PixelsMetaverse_Localhost31337_Material = async (
	contract: TContract,
	arg?: {
		uint256Params1: string | number; //uint256
	}
...
//nonpayable
export const PixelsMetaverse_Localhost31337_ReMake = async (
	contract: TContract,
	arg?: {
		id: string | number; //uint256
		num: string | number; //uint256
...
//nonpayable
export const PixelsMetaverse_Localhost31337_Register = async (
	contract: TContract,
) => {
	if ((contract as any)?.address && !(contract as any)?.methods) {
...
//nonpayable
export const PixelsMetaverse_Localhost31337_SetConfig = async (
	contract: TContract,
	arg?: {
		role: string; //string
		id: string | number; //uint256
...
//nonpayable
export const PixelsMetaverse_Localhost31337_SetPMT721 = async (
	contract: TContract,
	arg?: {
...
//nonpayable
export const PixelsMetaverse_Localhost31337_Subtract = async (
	contract: TContract,
	arg?: {
		ids: string | number; //uint256
		id: string | number; //uint256
...
//view
export const PixelsMetaverse_Localhost31337_User = async (
	contract: TContract,
	arg?: {
		addressParams1: string; //address
	}
