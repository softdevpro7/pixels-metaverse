...
//nonpayable
export const PMT721_Ganache1337_Approve = async (
	contract: TContract,
	arg?: {
		to: string; //address
...
//view
export const PMT721_Ganache1337_BalanceOf = async (
	contract: TContract,
	arg?: {
...
//nonpayable
export const PMT721_Ganache1337_Burn = async (
	contract: TContract,
	arg?: {
...
//view
export const PMT721_Ganache1337_CurrentID = async (
	contract: TContract,
) => {
	if ((contract as any)?.address && !(contract as any)?.methods) {
...
//view
export const PMT721_Ganache1337_Exits = async (
	contract: TContract,
	arg?: {
		id: string | number; //uint256
	}
...
//view
export const PMT721_Ganache1337_GetApproved = async (
	contract: TContract,
	arg?: {
		tokenId: string | number; //uint256
	}
...
//view
export const PMT721_Ganache1337_GetMinter = async (
	contract: TContract,
) => {
	if ((contract as any)?.address && !(contract as any)?.methods) {
...
//view
export const PMT721_Ganache1337_IsApprovedForAll = async (
	contract: TContract,
	arg?: {
		owner: string; //address
...
//nonpayable
export const PMT721_Ganache1337_Mint = async (
	contract: TContract,
	arg?: {
		to: string; //address
	}
...
//view
export const PMT721_Ganache1337_Name = async (
	contract: TContract,
) => {
	if ((contract as any)?.address && !(contract as any)?.methods) {
...
//view
export const PMT721_Ganache1337_OwnerOf = async (
	contract: TContract,
	arg?: {
		tokenId: string | number; //uint256
	}
...
//nonpayable
export const PMT721_Ganache1337_SafeTransferFrom = async (
	contract: TContract,
	arg?: {
		from: string; //address
		to: string; //address
...
//nonpayable
export const PMT721_Ganache1337_SafeTransferFromFromToTokenId_data = async (
	contract: TContract,
	arg?: {
		from: string; //address
		to: string; //address
...
//nonpayable
export const PMT721_Ganache1337_SetApprovalForAll = async (
	contract: TContract,
	arg?: {
		operator: string; //address
...
//nonpayable
export const PMT721_Ganache1337_SetMinter = async (
	contract: TContract,
	arg?: {
...
//view
export const PMT721_Ganache1337_SupportsInterface = async (
	contract: TContract,
	arg?: {
...
//view
export const PMT721_Ganache1337_Symbol = async (
	contract: TContract,
) => {
	if ((contract as any)?.address && !(contract as any)?.methods) {
...
//view
export const PMT721_Ganache1337_TokenURI = async (
	contract: TContract,
	arg?: {
		tokenId: string | number; //uint256
	}
...
//nonpayable
export const PMT721_Ganache1337_TransferFrom = async (
	contract: TContract,
	arg?: {
		from: string; //address
		to: string; //address
